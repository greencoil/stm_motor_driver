#ifndef _ROS_SERVICE_get_silicon_lid_from_rack_h
#define _ROS_SERVICE_get_silicon_lid_from_rack_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GET_SILICON_LID_FROM_RACK[] = "loraine_tasks/get_silicon_lid_from_rack";

  class get_silicon_lid_from_rackRequest : public ros::Msg
  {
    public:
      typedef int32_t _lid_num_type;
      _lid_num_type lid_num;

    get_silicon_lid_from_rackRequest():
      lid_num(0)
    {
    }
    ...
    const char * getType(){ return GET_SILICON_LID_FROM_RACK; };
    const char * getMD5(){ return "0cad7ce1e074c104e12f4c514f753a53"; };

  };

  class get_silicon_lid_from_rackResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    get_silicon_lid_from_rackResponse():
      success(0)
    {
    }
  ...
  class get_silicon_lid_from_rack {
    public:
    typedef get_silicon_lid_from_rackRequest Request;
    typedef get_silicon_lid_from_rackResponse Response;
  };

#ifndef _ROS_SERVICE_get_silicon_lid_from_al_dish_h
#define _ROS_SERVICE_get_silicon_lid_from_al_dish_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GET_SILICON_LID_FROM_AL_DISH[] = "loraine_tasks/get_silicon_lid_from_al_dish";

  class get_silicon_lid_from_al_dishRequest : public ros::Msg
  {
    public:
      typedef int32_t _hotplate_num_type;
      _hotplate_num_type hotplate_num;

    get_silicon_lid_from_al_dishRequest():
      hotplate_num(0)
    {
    }
    ...
    const char * getType(){ return GET_SILICON_LID_FROM_AL_DISH; };
    const char * getMD5(){ return "63e11edfae010770fdf1a26967083e41"; };

  };

  class get_silicon_lid_from_al_dishResponse : public ros::Msg
  {
    public:
      typedef bool _success_type;
      _success_type success;

    get_silicon_lid_from_al_dishResponse():
      success(0)
    {
    }
  ...
  class get_silicon_lid_from_al_dish {
    public:
    typedef get_silicon_lid_from_al_dishRequest Request;
    typedef get_silicon_lid_from_al_dishResponse Response;
  };

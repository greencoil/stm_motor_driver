#ifndef _ROS_SERVICE_SetJOGJointParams_h
#define _ROS_SERVICE_SetJOGJointParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETJOGJOINTPARAMS[] = "dobot/SetJOGJointParams";

  class SetJOGJointParamsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETJOGJOINTPARAMS; };
    const char * getMD5(){ return "56415298907749fc622f73f4a2f4c767"; };

  };

  class SetJOGJointParamsResponse : public ros::Msg
  {
    public:

#ifndef _ROS_SERVICE_SetPTPJointParams_h
#define _ROS_SERVICE_SetPTPJointParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETPTPJOINTPARAMS[] = "dobot/SetPTPJointParams";

  class SetPTPJointParamsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETPTPJOINTPARAMS; };
    const char * getMD5(){ return "56415298907749fc622f73f4a2f4c767"; };

  };

  class SetPTPJointParamsResponse : public ros::Msg
  {
    public:

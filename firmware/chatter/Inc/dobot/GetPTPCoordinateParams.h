#ifndef _ROS_SERVICE_GetPTPCoordinateParams_h
#define _ROS_SERVICE_GetPTPCoordinateParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETPTPCOORDINATEPARAMS[] = "dobot/GetPTPCoordinateParams";

  class GetPTPCoordinateParamsRequest : public ros::Msg
  {
    public:

    GetPTPCoordinateParamsRequest()
    {
    }
    ...
    const char * getType(){ return GETPTPCOORDINATEPARAMS; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetPTPCoordinateParamsResponse : public ros::Msg
  {
    public:
    ...
    GetPTPCoordinateParamsResponse():
      result(0),
      xyzVelocity(0),
      rVelocity(0),
      xyzAcceleration(0),

#ifndef _ROS_SERVICE_GetIODI_h
#define _ROS_SERVICE_GetIODI_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETIODI[] = "dobot/GetIODI";

  class GetIODIRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETIODI; };
    const char * getMD5(){ return "972132462544b1029bf37f19a88e11c4"; };

  };

  class GetIODIResponse : public ros::Msg
  {
    public:

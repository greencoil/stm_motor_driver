#ifndef _ROS_SERVICE_SetPTPCommonParams_h
#define _ROS_SERVICE_SetPTPCommonParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETPTPCOMMONPARAMS[] = "dobot/SetPTPCommonParams";

  class SetPTPCommonParamsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETPTPCOMMONPARAMS; };
    const char * getMD5(){ return "9e4dfb14c361852ecf51f33906a36bdb"; };

  };

  class SetPTPCommonParamsResponse : public ros::Msg
  {
    public:

#ifndef _ROS_SERVICE_SetIODO_h
#define _ROS_SERVICE_SetIODO_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETIODO[] = "dobot/SetIODO";

  class SetIODORequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETIODO; };
    const char * getMD5(){ return "c157ceb94ff4488daee759ac464a6c3e"; };

  };

  class SetIODOResponse : public ros::Msg
  {
    public:

...
static const char SETCOLORSENSOR[] = "dobot/SetColorSensor";
  ...
  class SetColorSensorRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_enableCtrl.base >> (8 * 0)) & 0xFF;
      ...
      u_colorPort.real = this->colorPort;
      *(outbuffer + offset + 0) = (u_colorPort.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_colorPort.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_colorPort.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_colorPort.base >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_colorPort.base = 0;
      u_colorPort.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_colorPort.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_colorPort.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_colorPort.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->colorPort = u_colorPort.real;
      offset += sizeof(this->colorPort);
     return offset;
    }

    const char * getType(){ return SETCOLORSENSOR; };
    const char * getMD5(){ return "63fa2c7813ac4b03b676ca34b5daeab7"; };

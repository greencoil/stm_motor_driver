#ifndef _ROS_SERVICE_GetJOGJointParams_h
#define _ROS_SERVICE_GetJOGJointParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETJOGJOINTPARAMS[] = "dobot/GetJOGJointParams";

  class GetJOGJointParamsRequest : public ros::Msg
  {
    public:

    GetJOGJointParamsRequest()
    {
    }
    ...
    const char * getType(){ return GETJOGJOINTPARAMS; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetJOGJointParamsResponse : public ros::Msg
  {
    public:

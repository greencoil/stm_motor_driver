#ifndef _ROS_SERVICE_GetJOGCommonParams_h
#define _ROS_SERVICE_GetJOGCommonParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETJOGCOMMONPARAMS[] = "dobot/GetJOGCommonParams";

  class GetJOGCommonParamsRequest : public ros::Msg
  {
    public:

    GetJOGCommonParamsRequest()
    {
    }
    ...
    const char * getType(){ return GETJOGCOMMONPARAMS; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetJOGCommonParamsResponse : public ros::Msg
  {
    public:

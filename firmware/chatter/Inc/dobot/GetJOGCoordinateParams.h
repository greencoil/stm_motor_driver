#ifndef _ROS_SERVICE_GetJOGCoordinateParams_h
#define _ROS_SERVICE_GetJOGCoordinateParams_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETJOGCOORDINATEPARAMS[] = "dobot/GetJOGCoordinateParams";

  class GetJOGCoordinateParamsRequest : public ros::Msg
  {
    public:

    GetJOGCoordinateParamsRequest()
    {
    }
    ...
    const char * getType(){ return GETJOGCOORDINATEPARAMS; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetJOGCoordinateParamsResponse : public ros::Msg
  {
    public:
    ...
    GetJOGCoordinateParamsResponse():
      result(0),

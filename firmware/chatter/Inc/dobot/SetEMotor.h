#ifndef _ROS_SERVICE_SetEMotor_h
#define _ROS_SERVICE_SetEMotor_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETEMOTOR[] = "dobot/SetEMotor";

  class SetEMotorRequest : public ros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->isEnabled >> (8 * 0)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->index);
      this->isEnabled =  ((uint8_t) (*(inbuffer + offset)));
      offset += sizeof(this->isEnabled);
      union {
        float real;
        uint32_t base;
    ...
    const char * getType(){ return SETEMOTOR; };
    const char * getMD5(){ return "a0b8b69832b27e55b0a75bdb6a06ce14"; };

  };

  class SetEMotorResponse : public ros::Msg
  {
    public:
